...
const hallows = [
  {
    name: "The Elder Wand",
    description: "The most powerful wand ever made...",
    image: "src/assets/images/dh1.jpeg"
  },
  {
    name: "The Resurrection Stone",
    description: "A stone that can recall loved ones from death...",
    image: "src/assets/images/dh2.jpeg"
  },
  {
    name: "The Invisibility Cloak",
    description: "A cloak that provides true invisibility...",
